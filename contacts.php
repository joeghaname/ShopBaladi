...
$content = "Client Name: " . $fname . " " . $lname . "\n" . "Client Email: " . $email . "\n" . $message;

$recipeint = "josephelghaname@gmail.com";
...
<div class='jumbotron'>
  <div class='alert alert-success' role='alert'>";
     echo" <h4 class='alert-heading'>Message Sent Successfuly!</h4>
      <p>Hi "; echo $fname; echo "! We hope you are enjoying your experience at ShopBaladi!</p>
      <hr>
      <p class='mb-0'>We will get back to you as soon as possible! Check your email (and spam folder).</p>
    </div>
</div>";

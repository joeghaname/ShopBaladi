...
<html lang="en">
  <head>
    ...
    <title>ShopBaladi - Add Product</title>
...
<div class="jumbotron">
    ...
    <hr class="my-4">
  <form class="needs-validation" novalidate action="addproducts.php" enctype="multipart/form-data" method="post">
    <div class="form-row">
      ...
      <div class="col-md-4 mb-3">
        <label for="price">Price</label> <span class="text-muted">(CAD)</span>
    ...
    <div class="col-md-4 mb-3">
      ...
      <select class="custom-select" id="cat" name="category" required>
    ...
    <div class="col-md-4 mb-3">
        ...
        <textarea class="form-control" id="description" name="description" placeholder="Product X is..." required></textarea>
        <div class="invalid-feedback">
    ...
    <div class="custom-file col-md-8 mb-3">
        ...
        <label class="custom-file-label" for="fileToUpload">Choose image file</label>
    </div>
    </div>
